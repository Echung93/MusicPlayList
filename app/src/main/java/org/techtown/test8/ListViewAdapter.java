...
public class ListViewAdapter extends ArrayAdapter implements View.OnClickListener  {
    private ArrayList<PlayListItem> listViewItemPlayList = new ArrayList<PlayListItem>() ;
    ...
    ListViewAdapter(Context context, int resource, ArrayList<PlayListItem> list, ListBtnClickListener clickListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final PlayListItem listViewItem = (PlayListItem) getItem(position);
